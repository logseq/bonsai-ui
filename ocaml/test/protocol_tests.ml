...
let test_retired_scroll_header_nodes_are_rejected () =
  List.iter
    ...
    [ {|42 53 46 52 04 00 00 00 30 00 03 00
...
00 00 00 11 40 00 0a 00 00 00 00|}
    ; {|4253465204000000300003005a00000000000000010000000000000002000000000000002900000000000000000000000100000000031a0000000100000000000000270001000000000000000000000000c04a400a00000000|}
    ]
;;
...
let test_retired_navigation_bar_wire_is_rejected () =
  let bytes =
    bytes_of_hex
      {|
4253465204000000300003005a00000000000000010000000000000002000000
...
let () =
  match
    Binary_codec.decode
      (bytes_of_hex
         "4253465204000000300003005a0000000000000001000000000000000200000000000000210000000000000000000000010000000003120000000100000000000000220000000000000000000a00000000")
  with
  | Error { code = Binary_codec.Unknown_node_kind; _ } -> ()
