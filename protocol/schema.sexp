((protocol
 ...
 (kind_props
  ((native_list ((style 1 enum_u8) (scroll_request 2 optional_list_scroll_request)))
   (navigation_link ((activation_id 1 string) (enabled 2 bool)))
   (list_section ((has_header 1 bool) (has_footer 2 bool) (separator 3 enum_u8) (section_key 4 string)))
   (list_row ((separator 1 enum_u8) (row_key 2 string) (expanded 3 optional_bool)))
   (list_row_label ())
   (context_menu ((enabled 1 bool)))
   (context_action ((action_key 1 string) (title 2 string) (enabled 3 bool) (role 4 u8) (symbol 5 optional_string)))
   (context_menu_view ())
   ...
   (toolbar ())
   (toolbar_entry ((entry_key 1 string) (placement 2 u8) (kind 3 u8)))
   (toolbar_child ((child_key 1 string)))
   (toolbar_body ())
   (confirmation ((style 1 u8) (request_token 2 optional_i64) (title 3 string) (message 4 optional_string) (actions 5 confirmation_actions)))
   ...
   (label ())
   (form ())
   (section ((has_header 1 bool) (has_footer 2 bool)))
   (labeled_content ())
   (content_unavailable ())
   (text_selection ((enabled 1 bool)))
 ...
 (event_tags
  ((press 1 unit)
   ...
   (list_scroll_completed 59 i64_pair)
   (confirmation_response 60 confirmation_response)
