...
| Expandable_message_composer | Standard SwiftUI kind 7/version 2 | Native launcher and Sheet share one retained editor; remove Scaffold placement and old schema decoding. |
